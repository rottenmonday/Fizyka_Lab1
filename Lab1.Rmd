...
prost_a_avg <- round(mean(pomiar_ab$a), 2) * 10
prost_b_avg <- round(mean(pomiar_ab$b), 2) * 10
prost_V <- round(prost_h_avg * prost_a_avg * prost_b_avg, 2)

prost_B <- round(sqrt((0.01/sqrt(3))^2 + (0.005/sqrt(3))^2), 4)
...
Wysokość prostopadłościanu mierzono za pomocą mikrometru, którego niepewność wzorcowania wynosi 0.01mm. Niepewność eksperymentatora przyjęto za 0.005mm. Niepewność typu B dla wysokości wynosi więc 0.01/sqrt(3) + 0.005/sqrt(3) = 0.0057mm.  Odchylenie standardowe wysokości prostopadłościanu jest równe `r prost_h_sd`mm, co ze wzoru ... oznacza, że niepewność typu A wynosi `r prost_h_sd/sqrt(30)`mm. , więc niepewność całkowita pomiaru wysokości wynosi: 
